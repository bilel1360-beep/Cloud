...
import org.fog.test.perfeval.datasetgen.RuntimeDatasetCollector;
            ...
            for (Vm vm : host.getVmList()) {
                while (vm.getCloudletScheduler().isFinishedCloudlets()) {
                    ...
                    if (cl != null) {
                        ...
                        int activeModules =
                                getHost().getVmList().size();
                        int queueSize = 0;

                        for (Vm currentVM : getHost().getVmList()) {
                        ...
                        int activeTuples =
                                queueSize;
                        RuntimeDatasetCollector.log(
                        	    "FINISH",
                        	    tuple.getCloudletId(),
                        	    tuple.getAppId(),
                        	    tuple.getTupleType(),
                        	    tuple.getSrcModuleName(),
